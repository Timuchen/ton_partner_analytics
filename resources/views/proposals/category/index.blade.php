      ...
      <ul class="flex self-start inline w-auto px-3 py-1 mt-3 text-xs font-medium text-gray-600 bg-blue-100 rounded-md">
		...
		<div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4 flex flex-col px-8 mx-auto my-6 lg:flex-row max-w-7xl xl:px-5">
			...
			<div class="flex items-center p-4 bg-white rounded-lg shadow-xs">
				...
				<div>
					...
					@if(count($allProps->where('proposal_status_id','=',5))>0)
        ...
        <div class="flex flex-col px-8 mx-auto my-6 max-w-7xl xl:px-5">
                        ...
                        <div id="tab-contents">
                          ...
                          <div id="second" >
                          <div class="text-lg font-semibold text-gray-500" style="text-align: center;">Analytics not available. Too few requests - 2020.</div>
                          </div>
                          <div id="third" >
                          <div class="text-lg font-semibold text-gray-500" style="text-align: center;">Analytics not available. Too few requests - 2021.</div>
                          </div>
                        </div>
</div>
